...
# DF will all values, MICs not binned
...
################################################################################
# Bubble plots
flc_sum <- mic_flc %>% group_by(mic50, genus_species) %>% count()
...
mcf_sum <- mic_mcf %>% group_by(mic50, genus_species) %>% count()
...
amb_sum <- mic_amb %>% group_by(mic90, genus_species) %>% count()
...
ggsave("MEC_FLC_summary.pdf", flc_bubble, width = 7, height = 5, units = "in")
ggsave("MEC_MCF_summary.pdf", mcf_bubble, width = 7, height = 5, units = "in")
ggsave("MEC_AMB_summary.pdf", amb_bubble, width = 7, height = 5, units = "in")

################################################################################
# MIC barplot per drug, faceted
# Two y-axis scales combined with patchwork
flc_fig1 <- ggplot(mic_flc %>% filter(genus_species %in% c("C. albicans", 
                                                           "C. glabrata", 
                                                           "C. parapsilosis",
  ...
  ylab("Isolates (N)") + 
  xlab(NULL) +
  geom_vline(data = filter(mic_flc, genus_species=="C. glabrata"), 
             aes(xintercept = 6.5), 
             linetype = 2) +
...
flc_fig2 <- ggplot(mic_flc %>% filter(genus_species %in% c("C. krusei", 
                                                    "C. orthopsilosis", 
                                                    "C. kefyr",
                                                    "C. tropicalis",
                                                    "C. utilis", 
  ...
  geom_vline(data=filter(mic_flc, genus_species %in% c("C. orthopsilosis", 
                                                       "C. kefyr",
                                                        "C. tropicalis",
                                                        "C. utilis", 
                                                        "C. dubliniensis", 
...
mcf_fig1 <- ggplot(mic_mcf %>% filter(genus_species %in% c("C. albicans", 
                                                           "C. glabrata", 
                                                           "C. parapsilosis",
                                                           "C. lusitaniae")), aes(x = mic50)) + 
  geom_bar(aes(fill = genus_species)) + 
...
mcf_fig2 <- ggplot(mic_mcf %>% filter(genus_species %in% c("C. krusei", 
                                                           "C. orthopsilosis", 
                                                           "C. kefyr",
                                                           "C. tropicalis",
                                                           "C. utilis", 
...
amb_fig1 <- ggplot(mic_amb %>% filter(genus_species %in% c("C. albicans", 
                                                           "C. glabrata", 
                                                           "C. parapsilosis",
...
amb_fig2 <- ggplot(mic_amb %>% filter(genus_species %in% c("C. krusei", 
                                                           "C. orthopsilosis", 
                                                           "C. kefyr",
                                                           "C. tropicalis",
                                                           "C. utilis", 
